...
- RS-1084 [BUG] UWC always uses develop helm chart
- RS-1085 [BUG] UWC - No Helm Chart 1.10.0 available on registry
- RS-1086 [BUG] UWC - Error while getting data from server: u.BooleanAttributes is undefined
...
- RS-922: Adding bearer token when downloading products and quicklooks
...
- RS-960: Pagination historic is not kept by result panel
- RS-967: Improving multiple features of the UWC for a better UX after feedback meeting
